        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'  => 'admin_panel/jobseekers/list',
                ],
                [
                    'text' => 'recruiters',
                    'icon' => 'fas fa-fw fa-user-tie',
                    'url'  => 'admin_panel/recruiters/list',
                ],
                [
                    'text' => 'admins',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'jobseekers',
                    'icon' => 'fas fa-fw fa-briefcase',
                    'url'  => 'admin_panel/jobseekers/deleted',
                ],
                [
                    'text' => 'recruiters',
                    'icon' => 'fas fa-fw fa-user-tie',
                    'url'  => 'admin_panel/recruiters/deleted',
                ],
                [
                    'text' => 'admins',
                    'icon' => 'fas fa-fw fa-universal-access',
                ...
                [
                    ...
                    'url'  => 'admin_panel/customers/deleted',
                ],
            ],
        ],
        /* [
