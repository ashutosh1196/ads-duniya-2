    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="addAdminForm" method="post", action="{{route('loans.save')}}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">                
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <select name="type" id="type" class="form-control">
                        ...
                        @foreach(\App\Models\Loan::LOANS as $loan)
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="interest_rate" class="form-control" id="interest_rate" maxlength="100">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="processing_fee" class="form-control" id="processing_fee" maxlength="100">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="tenure_range" class="form-control" id="tenure_range" maxlength="100">
    ...
    $(document).ready(function() {
      ...
      $('#addAdminForm').validate({
        ...
        messages: {
          ...
          type: {
            required: "The Loan Type is required."
          },
          processing_fee: {
            required: "The Processing Fee is required."
          },
          tenure_range: {
            required: "The Tenure Range is required."
          },
          interest_rate: {
