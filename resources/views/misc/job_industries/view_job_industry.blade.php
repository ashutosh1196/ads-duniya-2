            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ date('d/m/y', strtotime($jobIndustry[0]->created_at)) }}" readonly>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ date('d/m/y', strtotime($jobIndustry[0]->updated_at)) }}" readonly>
                </div>
              </div>
            </div>
