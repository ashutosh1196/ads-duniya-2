              ...
              <tbody>
                <?php for ($i=0; $i < count((is_countable($deletedAdmins)?$deletedAdmins:[])); $i++) { ?>
                  <tr>
                    ...
                    <th>View</th>
                    <td>
                      <a class="action-button" title="View" href="view/{{$deletedAdmins[$i]->id}}"><i class="text-info fa fa-eye"></i></a>
...
@section('js')
  ...
  <script>
    ...
    $('.delete-button').click(function(e) {
      ...
      swal({
        title: "Are you sure?",
        text: "Do you want to restore the Admin?",
        type: "warning",
