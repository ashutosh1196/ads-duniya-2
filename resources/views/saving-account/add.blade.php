...
@section('title', 'Add Saving Account Info')
    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="addAdminForm" method="post", action="{{route('saving-accounts.save')}}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">                
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="opening_charge" class="form-control" id="opening_charge" maxlength="100">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="minimum_balance" class="form-control" id="minimum_balance" maxlength="100">
