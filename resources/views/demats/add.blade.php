    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="addAdminForm" method="post", action="{{route('demats.save')}}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">                
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="exchange" class="form-control" id="exchange" maxlength="100">
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="trading_account_opening_fee" class="form-control" id="trading_account_opening_fee" maxlength="100">                      
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="demat_account_opening_fee" class="form-control" id="demat_account_opening_fee" maxlength="100">                      
                    </div>
                  </div>
