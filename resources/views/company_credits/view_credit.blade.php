            ...
            <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ $companyCreditsList[0]->name }}" readonly>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="${{ $companyCreditsList[0]->credit_amount ? $companyCreditsList[0]->credit_amount : '0.00' }}" readonly>
                </div>
              </div>
            </div>
