...
@section('title', 'Edit Power Equipment')
      ...
      <div class="col-12">
        <div class="sell_form">
          ...
          <div class="title text-center">
            <h4>Edit Power Equipment Details</h4>
          </div>
          <form id="sell_equipment_form" action="{{route('update-power-equipment')}}" method="post" enctype="multipart/form-data">
            @csrf
             ...
             <div class="col-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="output_frequency" name="output_frequency" value="{{$inventory->output_frequency}}">
                </div>
              </div>
