              ...
              <div class="card-body">
                ...
                <div class="information_fields">
                 ...
                 <div class="row">
                  <div class="col-sm-6">
                      <div class="form-group">
                        <label for="make">Vehicle Type<span class="text-danger"> *</span></label>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                        <label for="vin">Model Year<span class="text-danger"> *</span></label>
                        <input type="text" name="vin" placeholder="Model Year"class="form-control" id="vin" maxlength="100">
                        @error('vin')
                        <div id ="car_error" class="error">{{ $message }}</div>
                        @enderror
                      </div>
